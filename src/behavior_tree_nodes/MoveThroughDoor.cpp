...
BT::NodeStatus MoveThroughDoor::on_tick()
{
...
BT::NodeStatus MoveThroughDoor::on_success() {return BT::NodeStatus::SUCCESS;}
...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerBuilder<plansys2_gpsr_ros2d2::MoveThroughDoor>("MoveThroughDoor", builder);
}
